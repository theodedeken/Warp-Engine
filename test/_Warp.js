...
function integrateWasmJS() {
  ...
  var wasmTextFile = 'Warp.wast';
  var wasmBinaryFile = '../build/Warp.wasm';
  var asmjsCodeFile = 'Warp.temp.asm.js';
...
/* global initializers */  __ATINIT__.push({ func: function() { __GLOBAL__sub_I_VectorDouble_cpp() } }, { func: function() { __GLOBAL__sub_I_VectorInt_cpp() } }, { func: function() { __GLOBAL__sub_I_bind_cpp() } });
...
Module['wasmTableSize'] = 1025;

Module['wasmMaxTableSize'] = 1025;
...
Module["asm"] = asm;
var __GLOBAL__sub_I_VectorDouble_cpp = Module["__GLOBAL__sub_I_VectorDouble_cpp"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return Module["asm"]["__GLOBAL__sub_I_VectorDouble_cpp"].apply(null, arguments) };
var __GLOBAL__sub_I_VectorInt_cpp = Module["__GLOBAL__sub_I_VectorInt_cpp"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return Module["asm"]["__GLOBAL__sub_I_VectorInt_cpp"].apply(null, arguments) };
